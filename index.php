...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="https://www.touchstonemag.com/bs5/conference.css" />
    <!--Jerry has added some serious notage here-->
    <!--Jerry has added some serious notage here-->
    <!--Jerry has added some serious notage here-->
    <!--Jerry has added some serious notage here-->
...
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v11.0&appId=1928159247435390&autoLogAppEvents=1" nonce="DqHX3A84"></script>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="d-flex">
        <a class="btn btn-light" href="https://interland3.donorperfect.net/weblink/WebLink.aspx?name=E350987&id=9">Register at Super Early Bird Rate!</a>
      </form>
    </div>
  </div>
</nav>
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                ...
                <p class="ticket-info">There are a limited number of rooms discounted for <em>Touchstone </em>conference attendees at the <a href="https://www.wyndhamhotels.com/laquinta/bannockburn-illinois/la-quinta-bannockburn-deerfield/overview" target="_blank">La Quinta</a> directly adjacent to Trinity International University. Call and mention the <em>Touchstone </em> conference to reserve your room.</p>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <center>
                    ...
                    <p class="ticket-info"><br /><br />Ticket pricing breakdown below.<br /><em>NOTE: Super Early Bird &amp; Student Rate registrations cannot be completed in the same transaction. <br />Please register students at the Student Rate separately. <br />Sorry for any inconvenience. </em></p>
                </center>
